...
// Icones
import { Search, Bell, BellOff, LogOut, Plus, Droplets, CheckCircle2, Sprout, User } from 'lucide-react';
...
function App() {
  ...
  const waterAllThirsty = async () => {
    ...
    if (window.confirm(`Arroser les ${thirstyPlants.length} plantes ?`)) {
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-jungle-sage font-bold text-sm mt-1">
              {plants.length} plantes au total
            </p>
          </div>
            ...
            <div className="relative z-10">
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p className="text-jungle-terracotta text-xs font-black uppercase tracking-wider mt-1">{thirstyPlants.length} plantes ont soif</p>
                </div>
                <button 
