...
import { ChevronLeft, Calendar, Plus, MapPin, Droplets, Trash2, Quote, AlertTriangle } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-white z-50 flex flex-col animate-in slide-in-from-right duration-300">
      ...
      <div className="p-6 flex items-center justify-between border-b border-gray-100 shrink-0">
        <div className="flex items-center gap-4 text-left">
          <button onClick={onClose} className="p-2 bg-gray-50 rounded-full text-[#2A3930]">
            <ChevronLeft size={24} />
          </button>
        ...
        <button 
          ...
          className="p-2.5 bg-red-50 text-red-500 rounded-full active:scale-90 transition-transform"
        >
          <Trash2 size={20} />
        </button>
      </div>
        ...
        <div className="p-8 space-y-10 text-left">
          ...
          {plant.description && (
            <section className="bg-[#F9F7F2]/60 p-6 rounded-[2.5rem] border border-[#F9F7F2] relative">
              ...
              <p className="text-sm text-[#2A3930] font-medium leading-relaxed italic">
                {`"${plant.description}"`}
              </p>
            </section>
          )}
          ...
          {/* Historique Arrosage */}
          <section>
            <h3 className="text-[11px] font-black text-[#2A3930]/40 uppercase tracking-[0.2em] mb-5">Historique</h3>
          ...
          <section className="pb-20">
            <h3 className="text-[11px] font-black text-[#2A3930]/40 uppercase tracking-[0.2em] mb-5">Journal de bord</h3>
                ...
                return (
                  <div key={n.id} className="flex gap-5 items-start">
                    ...
                    <div className="flex-1 border-b border-gray-50 pb-4">
                      ...
                      <p className="text-sm text-[#2A3930] font-semibold leading-relaxed">{n.text}</p>
                    </div>
                  </div>
                );
              })}
